...
class OpenAIService:
    def __init__(self, chat_prompt, parser):
        ...
        self.tools = [datetime_tool, welcome_tool, bancos_tool, cartoes_tool, faturas_pendentes_tool, analyze_faturas_tool, entradas_tool, saidas_tool, balance_tool, compras_categoria_tool, insert_compra_tool]
